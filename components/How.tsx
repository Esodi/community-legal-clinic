    ...
    <Section className="relative bg-[#001a42] text-white py-20 overflow-hidden">
      ...
      >
        ...
        <div className="mt-12 text-center">
          <Button 
            className="bg-[#25D366] hover:bg-[#22c35e] text-white text-xl font-semibold h-14 w-full sm:w-auto px-4 sm:px-10 flex items-center justify-center gap-2 sm:gap-3 mx-auto rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 max-w-[90%] sm:max-w-none"
          >
            <svg 
